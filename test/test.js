...
describe('chi-square', function() {

  var nn;

  before(function() {
    nn = new ChiSquare(vectors);
  });
  ...
  it('should give the correct most similar', function() {
    ...
    // [32, 26, 0, 23, 0], [24, 17, 0, 25, 6] // these should be the most similar
